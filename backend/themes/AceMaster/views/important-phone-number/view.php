...
$this->title = sprintf("%s %s", AppLabels::BTN_VIEW, $model->ipn_instance_name);
$this->params['breadcrumbs'][] = ['label' => sprintf("Form %s", AppLabels::FORM_IPN), 'url' => ['index', '_ppId' => $model->power_plant_id]];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="important-phone-number-view">
