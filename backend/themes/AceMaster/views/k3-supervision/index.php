...
$buttons = array_merge($actionColumn->buttons, [
    ...
    'detail' => function ($url, $model) {
        return Html::a('<i class="ace-icon fa fa-circle bigger-120"></i> ' . AppLabels::BTN_DETAIL, ['k3-supervision-detail/index', '_ppId' => $model->powerPlant->id,  'ksId' => $model->id], ['class' => 'btn btn-xs', 'data' => ['method' => 'post']]);
    },
