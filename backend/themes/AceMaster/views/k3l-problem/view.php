...
$this->title = sprintf("%s %s", AppLabels::BTN_VIEW, $model->kp_problem_number);
$this->params['breadcrumbs'][] = ['label' => sprintf("Form %s", AppLabels::FORM_K3L_PROBLEM), 'url' => ['index', '_ppId' => $model->power_plant_id]];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="k3l-problem-view">

    <div class="page-header">
        <h1>
            <?= Html::encode(sprintf("%s %s", sprintf("Form %s", AppLabels::FORM_K3L_PROBLEM), $this->title)) ?>
            ...
            <?= DetailView::widget([
                ...
                'options' => [
                    'converter' => [
                        ...
                        'kp_status_code' => [AppConstants::FORMAT_TYPE_VARIABLE, $model->kp_status_code_desc],
                    ]
                ]
            ]);
            ?>
