...
?>
    <div class="hydrant-testing-form">

        <div class="row">
            <div class="col-xs-12 col-md-8 col-md-offset-2">
                <div class="widget-box">
                    <div class="widget-header">
                        <h4 class="widget-title"> <?= AppLabels::FORM_HYDRANT_TESTING ?> </h4>
                    </div>
                    <div class="widget-body">
                        <div class="widget-main">
                            <fieldset>
                                ...
                                echo $form->field($model, "ht_year", ['template' => AppConstants::ACTIVE_FORM_TEMPLATE_INPUT_COL_9_FULL])
