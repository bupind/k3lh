...
$this->title = sprintf("%s %s", AppLabels::BTN_VIEW, $model->wa_year);
$this->params['breadcrumbs'][] = ['label' => sprintf("Form %s", AppLabels::FORM_WORK_ACCIDENT), 'url' => ['index', '_ppId' => $model->power_plant_id]];
