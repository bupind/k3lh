...
$this->title = sprintf("Form %s %s", AppLabels::FORM_SLO_TOOLS, $powerPlantModel->getSummary());
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => 'st_category_desc',
                'filter' => Html::activeDropDownList($searchModel, 'st_category', Codeset::customMap(AppConstants::CODESET_SLOT_CATEGORY_CODE), ['class' => 'chosen-select form-control'])
            ],
