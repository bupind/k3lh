...
/* @var $searchModel backend\models\SloToolsSearch */
/* @var $powerPlantModel backend\models\PowerPlant */

$this->title = sprintf('%s %s', AppLabels::BTN_DOWNLOAD_EXCEL, AppLabels::FORM_SLO_TOOLS);
...
<div class="slo-tools-export">

    <div class="page-header">
        <h1><?= Html::encode($this->title) ?></h1>
    </div>

    <div class="row slo-tools-form">
        <div class="col-xs-12 col-md-6 col-md-offset-3">
            <?php

            echo$form->field($searchModel, "st_form_month_type_code", ['template' => AppConstants::ACTIVE_FORM_TEMPLATE_INPUT_COL_9_FULL])
            ...
            echo $form->field($searchModel, "st_year", ['template' => AppConstants::ACTIVE_FORM_TEMPLATE_INPUT_COL_9_FULL])
