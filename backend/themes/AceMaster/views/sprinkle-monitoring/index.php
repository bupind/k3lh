...
$buttons = array_merge($actionColumn->buttons, [
    ...
    'detail' => function ($url, $model) {
        return Html::a('<i class="ace-icon fa fa-circle bigger-120"></i> ' . AppLabels::BTN_DETAIL, ['sprinkle-monitoring-detail/index', '_ppId' => $model->powerPlant->id,  'smId' => $model->id], ['class' => 'btn btn-xs']);
    },
