...
$this->title = sprintf('%s %s %s', AppLabels::BTN_UPDATE, AppLabels::SELF_ASSESSMENT_SHORT, AppLabels::PLB3);
...
<div class="plb3-sa-form-update">
    ...
    <?= $this->render('_form', [
        'model' => $model,'startDate' => $startDate,
