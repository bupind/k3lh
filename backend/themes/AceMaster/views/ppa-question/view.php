...
<div class="ppa-question-view">
    ...
    <?= DetailView::widget([
        ...
        'options' => [
            'converter' => [
                'ppaq_question_type_code' => [AppConstants::FORMAT_TYPE_VARIABLE, $model->ppaq_question_type_code_desc]
            ]
        ]
    ]); ?>
