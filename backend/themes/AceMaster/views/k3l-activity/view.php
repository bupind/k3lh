...
$this->title = sprintf("%s %s", AppLabels::BTN_VIEW, $model->ka_name);
$this->params['breadcrumbs'][] = ['label' => sprintf("Form %s", AppLabels::FORM_K3L_ACTIVITY), 'url' => ['index', '_ppId' => $model->power_plant_id]];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="k3l-activity-view">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-6 col-md-offset-3">
            ...
            <?= DetailView::widget([
                'model' => $model,
                'options' => [
                    'extraAttributes' => ['attachment_owner' => Converter::attachment($model->attachmentOwner, [])],
                    'converter' => [
