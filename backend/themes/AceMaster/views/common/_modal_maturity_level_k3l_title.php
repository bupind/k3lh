...
<div id="maturity-level-k3l-title-modal" class="modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            $form = ActiveForm::begin([
                'action' => ['/maturity-level-k3l-title/ajax-create'],
                'id' => 'maturity-level-k3l-title-form',
                'options' => [
            ...
            <div class="modal-body">
                ...
                echo $form->field($maturityLevelK3lTitleMdl, 'title_text', ['template' => AppConstants::ACTIVE_FORM_TEMPLATE_INPUT_COL_9])
