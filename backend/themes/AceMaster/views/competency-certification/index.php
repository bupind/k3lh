...
/* @var $searchModel backend\models\CompetencyCertificationSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
/* @var $powerPlantModel backend\models\PowerPlant */

$this->title = sprintf("Form %s %s", AppLabels::FORM_COMPETENCY_CERTIFICATION, $powerPlantModel->getSummary());
...
?>
<div class="competency-certification-index">
