...
/* @var $searchModel backend\models\Plb3BalanceSheetSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
/* @var $powerPlantModel backend\models\PowerPlant */
/* @var $model backend\models\Plb3BalanceSheet */

$this->title = sprintf('Form %s %s %s',AppLabels::PERCENTAGE, AppLabels::BALANCE_SHEET, $powerPlantModel->getSummary());
...
?>
<div class="plb3-balance-sheet-index">
