...
/**
 * Plb3ChecklistSearch represents the model behind the search form about `backend\models\Plb3Checklist`.
 */
class Plb3ChecklistSearch extends Plb3Checklist
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'sector_id', 'power_plant_id', 'plb3c_year'], 'integer'],
        ];
    }
    ...
    public function export($id) {
        ...
        $query = Plb3Checklist::find()->where(['id' => $id]);
        ...
        $plb3ChecklistDetail = $model->plb3ChecklistDetails;
        ...
        $sheetIndex = 0;
        //Creating sheet
        foreach($plb3ChecklistDetail as $key => $value) {
            $this->exportPlb3ChecklistDetail($objPHPExcel, $sheetIndex++, $value);
        }
