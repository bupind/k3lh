...
/**
 * This is the model class for table "environment_permit_district".
 *
 * @property integer $id
 ...
 */
class EnvironmentPermitDistrict extends AppModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'environment_permit_district';
    }
    ...
    {
        return [
            [['environment_permit_report_id', 'ep_district'], 'required', 'message' => AppConstants::VALIDATE_REQUIRED],
            [['environment_permit_report_id'], 'integer', 'message' => AppConstants::VALIDATE_INTEGER],
            [['ep_district'], 'string', 'max' => 50],
    ...
    {
        return $this->hasOne(AttachmentOwner::className(), ['atfo_module_pk' => 'id'])->andOnCondition(['atfo_module_code' => AppConstants::MODULE_CODE_ENVIRONMENT_PERMIT_DISTRICT]);
    }
