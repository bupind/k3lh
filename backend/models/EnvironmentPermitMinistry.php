...
/**
 * This is the model class for table "environment_permit_ministry".
 *
 * @property integer $id
 * @property integer $environment_permit_report_id
 * @property string $ep_ministry
 ...
 */
class EnvironmentPermitMinistry extends AppModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'environment_permit_ministry';
    }
    ...
    {
        return [
            [['environment_permit_report_id', 'ep_ministry'], 'required', 'message' => AppConstants::VALIDATE_REQUIRED],
            [['environment_permit_report_id'], 'integer', 'message' => AppConstants::VALIDATE_INTEGER],
            [['ep_ministry'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'ep_ministry' => AppLabels::ENVIRONMENT_MINISTRY,
        ];
    }
    ...
    {
        return $this->hasOne(AttachmentOwner::className(), ['atfo_module_pk' => 'id'])->andOnCondition(['atfo_module_code' => AppConstants::MODULE_CODE_ENVIRONMENT_PERMIT_MINISTRY]);
    }
}
