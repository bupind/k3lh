...
use Yii;
use backend\models\EmergencyResponse;
use backend\models\EmergencyResponseSearch;
...
/**
 * EmergencyResponseController implements the CRUD actions for EmergencyResponse model.
 */
class EmergencyResponseController extends AppController
{
    ...
    {
        if (($model = EmergencyResponse::findOne($id)) !== null) {
            return $model;
        } else {
            throw new NotFoundHttpException('The requested page does not exist.');
        }
