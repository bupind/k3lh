jQuery(document).ready(function () {
    ...
    // =====================
    $('#maturity-level-title-modal').on('show.bs.modal', function(event){
    ...
    jQuery('body').on('beforeSubmit', 'form#maturity-level-title-form', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data !== false) {
                    ...
                    var inputWrapper = $('#input-maturity-level-title-wrapper'),
                        sb = new StringBuilder();
                
                    sb.append('<input type="hidden" name="'+ modelName +'[maturity_level_title_id]" value="'+ data['id'] +'" />');
                ...
                $('#maturity-level-title-modal').modal('hide');
            }
        });
    }).on('submit', 'form#maturity-level-title-form', function (e) {
        e.preventDefault();
    });
});