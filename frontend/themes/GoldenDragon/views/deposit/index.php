...
$this->title = sprintf('Deposit - %s', $webProfile->title_tag);
...
echo $form->field($model, 'dps_name')
    ->textInput(['maxlength' => true, 'class' => 'form-control'])
    ->label(null, ['class' => '']);

echo $form->field($model, 'dps_username')
    ->textInput(['maxlength' => true, 'class' => 'form-control'])
    ->label(null, ['class' => '']);

echo $form->field($model, 'dps_email')
    ->textInput(['maxlength' => true, 'class' => 'form-control'])
    ->label(null, ['class' => '']);

echo $form->field($model, 'dps_amount')
...
echo $form->field($model, 'dps_receiver_bank_id')
    ->dropDownList(Bank::map(new Bank(), 'bank_name'), ['class' => 'form-control'])
    ->label(null, ['class' => '']);

echo $form->field($model, 'dps_sender_bank_id')
    ->dropDownList(Bank::map(new Bank(), 'bank_name'), ['class' => 'form-control'])
    ->label(null, ['class' => '']);

echo $form->field($model, 'dps_account_name')
    ->textInput(['maxlength' => true, 'class' => 'form-control'])
    ->label(null, ['class' => '']);

echo $form->field($model, 'dps_account_no')
    ->textInput(['maxlength' => true, 'class' => 'form-control numbersOnly'])
    ->label(null, ['class' => '']);
